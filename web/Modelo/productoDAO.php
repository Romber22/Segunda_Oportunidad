...
class productoDAO extends Conexion {
    ...
    public function insertar_producto($producto) {
        try {
            $location = json_decode(file_get_contents("https://api.geoapify.com/v1/geocode/search?text=" . $producto->ubicacion . "&apiKey=fe245a628dd5432aa2047727cf89a15b"))->features;
